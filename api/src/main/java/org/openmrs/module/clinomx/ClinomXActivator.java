 ...
 */
public class ClinomXActivator implements ModuleActivator {

    private static final Log log = LogFactory.getLog(ClinomXActivator.class);
    ...
    public void willRefreshContext() {
        log.info("Refreshing ClinomX Module");
    }
    ...
    public void contextRefreshed() {
        log.info("ClinomX Module refreshed");
        try {
            seedDummyPatients();
        } catch (Exception e) {
    ...
    public void willStart() {
        log.info("Starting ClinomX Module");
    }
    ...
    @Override
    public void started() {
        log.info("ClinomX Module started");
        try {
            seedDummyPatients();
        } catch (Exception e) {
            log.error("Failed to seed dummy patients", e);
    ...
    public void willStop() {
        log.info("Stopping ClinomX Module");
    }
    ...
    @Override
    public void stopped() {
        log.info("ClinomX Module stopped");
    }
}
