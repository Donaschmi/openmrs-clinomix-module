...
import org.openmrs.module.clinomx.ClinomXConstants;
 ...
 * {@value ClinomXConstants#GP_FHIR_SERVER_URL}.
 *
...
public class FhirClientFactory {
    ...
    private static final String DEFAULT_FHIR_SERVER_URL = "http://clinom-x-hapi-fhir:8080/fhir";
    ...
    public FhirRestClient getClient() {
        String url = Context.getAdministrationService()
                .getGlobalProperty(ClinomXConstants.GP_FHIR_SERVER_URL, DEFAULT_FHIR_SERVER_URL);
